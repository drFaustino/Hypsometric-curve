...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'hypsometric_curve_dialog_base.ui'))


class HypsometricCurveDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(HypsometricCurveDialog, self).__init__(parent)
